...
@LazyjsonClass class DynamicNew (private val jsonObject: JsonObject) {
    companion object   {
        @LazyjsonFrom @JvmStatic fun from(jsonObject: JsonObject)  = DynamicNew(jsonObject)
    }
    ...
    class Data (private val jsonObject: JsonObject) {
        ...
        override fun toString()  = jsonObject.toString()
         val newNum: Number
            get() = jsonObject.get("new_num").asNumber
         val existGap: Number
            get() = jsonObject.get("exist_gap").asNumber
         val updateNum: Number
            get() = jsonObject.get("update_num").asNumber
         val openRcmd: Number
         ...
         val attentions: Attentions
            get() = jsonObject.get("attentions").asAttentions
         val maxDynamicId: Number
            get() = jsonObject.get("max_dynamic_id").asNumber
         val historyOffset: Long
            get() = jsonObject.get("history_offset").asLong
         val Gt: Number
        ...
        class Cards (private val jsonObject: JsonObject) {
            ...
            override fun toString()  = jsonObject.toString()
             ...
             val activityInfos: ActivityInfos?
                get() = jsonObject.get("activity_infos")?.asActivityInfos
            ...
            class Display (private val jsonObject: JsonObject) {
                ...
                override fun toString()  = jsonObject.toString()
                 ...
                 val emojiInfo: EmojiInfo?
                    get() = jsonObject.get("emoji_info")?.asEmojiInfo
                ...
                class Origin (private val jsonObject: JsonObject) {
                    ...
                    override fun toString()  = jsonObject.toString()
                     ...
                     val likeInfo: LikeInfo?
                        get() = jsonObject.get("like_info")?.asLikeInfo
                     val relation: Relation
                        get() = jsonObject.get("relation").asRelation
                     val topicInfo: TopicInfo?
                        get() = jsonObject.get("topic_info")?.asTopicInfo
                    ...
                    private val JsonElement.asEmojiInfo
                        get() = EmojiInfo(this.asJsonObject)
                    class EmojiInfo (private val jsonObject: JsonObject) {
                        fun getJsonObject()  = jsonObject
                        override fun toString()  = jsonObject.toString()
                         val emojiDetails: List<EmojiDetails>
                            get() = jsonObject.get("emoji_details").asJsonArray.map { it.asEmojiDetails }
                        private val JsonElement.asEmojiDetails
                            get() = EmojiDetails(this.asJsonObject)
                        class EmojiDetails (private val jsonObject: JsonObject) {
                            fun getJsonObject()  = jsonObject
                            override fun toString()  = jsonObject.toString()
                             val emojiName: String
                                get() = jsonObject.get("emoji_name").asString
                    ...
                    private val JsonElement.asLikeInfo
                        get() = LikeInfo(this.asJsonObject)
                    class LikeInfo (private val jsonObject: JsonObject) {
                        fun getJsonObject()  = jsonObject
                        override fun toString()  = jsonObject.toString()
                         val displayText: String
                            get() = jsonObject.get("display_text").asString
                         val likeUsers: List<LikeUsers>
                            get() = jsonObject.get("like_users").asJsonArray.map { it.asLikeUsers }
                        private val JsonElement.asLikeUsers
                            get() = LikeUsers(this.asJsonObject)
                        class LikeUsers (private val jsonObject: JsonObject) {
                            fun getJsonObject()  = jsonObject
                            override fun toString()  = jsonObject.toString()
                             val uid: Number
                                get() = jsonObject.get("uid").asNumber
            ...
            private val JsonElement.asActivityInfos
                get() = ActivityInfos(this.asJsonObject)
            class ActivityInfos (private val jsonObject: JsonObject) {
                fun getJsonObject()  = jsonObject
                override fun toString()  = jsonObject.toString()
                 val details: List<Details>
                    get() = jsonObject.get("details").asJsonArray.map { it.asDetails }
                private val JsonElement.asDetails
                    get() = Details(this.asJsonObject)
                class Details (private val jsonObject: JsonObject) {
                    fun getJsonObject()  = jsonObject
                    override fun toString()  = jsonObject.toString()
                     val type: Number
                        get() = jsonObject.get("type").asNumber
        ...
        private val JsonElement.asAttentions
            get() = Attentions(this.asJsonObject)
        class Attentions (private val jsonObject: JsonObject) {
            fun getJsonObject()  = jsonObject
            override fun toString()  = jsonObject.toString()
             val uids: List<Number>
                get() = jsonObject.get("uids").asJsonArray.map { it.asNumber }
             val bangumis: List<Bangumis>
                get() = jsonObject.get("bangumis").asJsonArray.map { it.asBangumis }
            private val JsonElement.asBangumis
                get() = Bangumis(this.asJsonObject)
            class Bangumis (private val jsonObject: JsonObject) {
                fun getJsonObject()  = jsonObject
                override fun toString()  = jsonObject.toString()
                 val seasonId: Number
