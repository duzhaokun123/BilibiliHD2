...
interface VcAPI {
    ...
    fun dynamicNew(
         @Query("type_list") typeList: Long = 268435455
    ): Deferred<DynamicNew>

    @GET("/dynamic_svr/v1/dynamic_svr/dynamic_history")
    fun dynamicHistory(
        @Query("offset_dynamic_id") offsetDynamicId: Long,
        @Query("page") page: Int,
        @Query("type_list") typeList: Long = 268435455
    ): Deferred<DynamicHistory>
}
